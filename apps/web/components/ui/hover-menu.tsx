  ...
  ({ children, className }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "min-w-[200px] rounded-2xl border-2 border-[#e5e5e5] bg-white shadow-xl shadow-black/10 py-1",
          className
        )}
      >
        {children}
  ...
  ({ children, className, onClick, asChild }, ref) => {
    ...
    return (
      <div
        ...
        onClick={onClick}
        className={cn(
          "px-3 py-2 text-sm text-[#777] hover:text-[#3c3c3c] hover:bg-[#f7f7f7] cursor-pointer transition-colors",
          className
        )}
      >
        {children}
  ...
  ({ children, className }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "px-3 py-2 text-xs font-bold text-[#afafaf] uppercase tracking-wide",
          className
        )}
      >
        {children}
