...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  signin_data_missing: 'The sign-in link did not contain the expected sign-in data.',
  signin_link_incomplete: 'The sign-in link is incomplete. Please return to the dashboard and click "Visit Site" again.',
  session_not_established: 'Could not establish a valid session. Please try again.',
